...
class LecturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post lecturers_url, params: { lecturer: { email: @lecturer.email, name: @lecturer.name, surname: @lecturer.surname } }
    end
  ...
  test "should update lecturer" do
    patch lecturer_url(@lecturer), params: { lecturer: { email: @lecturer.email, name: @lecturer.name, surname: @lecturer.surname } }
